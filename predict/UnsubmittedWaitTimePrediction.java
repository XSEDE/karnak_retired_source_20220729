...
public class UnsubmittedWaitTimePrediction extends UnsubmittedWaitTimeExperience implements WaitTimePrediction {

    private static Logger logger = Logger.getLogger(UnsubmittedWaitTimePrediction.class.getName());

    public Confidence conf = null;

    public UnsubmittedWaitTimePrediction() {
    }

    public UnsubmittedWaitTimePrediction(UnsubmittedWaitTimeExperience exp) {
        super(exp);
    }

    public UnsubmittedWaitTimePrediction(UnsubmittedWaitTimePrediction pred) {
        super((WaitTimeExperience)pred);
        conf = pred.conf;
    }

    public UnsubmittedWaitTimePrediction(Job job) {
        super(job);
    }
