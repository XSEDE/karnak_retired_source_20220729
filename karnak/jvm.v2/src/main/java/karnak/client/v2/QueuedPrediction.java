...
public long predictedWaitTimeSecs = -1;
public long confidenceIntervalSecs = -1;
...
public static QueuedPrediction fromDom(Document doc) {
        ...
        try {
                ...
                pred.predictedWaitTimeSecs = Math.round((pred.predictedStartTime.getTime() - pred.generatedAt.getTime()) / 1000);
