...
@Path("/karnak/waittime")
public class WaitTimeResource extends TimeResource {
	...
	return super.getPredictHtml(true,systems,queueAtSystems,coresStr,hours,minutes,confidenceStr);
    }
	...
	return super.getPredictionText(true,id);
    }
	...
	return super.getPredictionXml(true,id);
    }
	...
	return super.getPredictionJson(true,id);
    }
    ...
    public String getSystemHtml(@PathParam("system") String system,
	                        @DefaultValue("90") @QueryParam("confidence") String confidenceStr) {
	system = system.replace("teragrid.org","xsede.org");
	return JobResource.getWaitingJobsHtml(system,true,false);
    }
    ...
    /*
    @Path("{system}/job-{id}/prediction.txt")
    @GET 
    @Produces("text/plain")
    public String getJobText(@PathParam("system") String system,
			     @PathParam("id") String jobId,
			     @DefaultValue("90") @QueryParam("confidence") String confidenceStr) {
	return getJobText(true,system,jobId,confidenceStr);
    }

    @Path("{system}/job-{id}/prediction.html")
    @GET 
    @Produces("text/html")
    public String getJobHtml(@PathParam("system") String system,
			     @PathParam("id") String jobId,
			     @DefaultValue("90") @QueryParam("confidence") String confidenceStr) {
	return getJobHtml(true,system,jobId,confidenceStr);
    }

    @Path("{system}/job-{id}/prediction.xml")
    @GET 
    @Produces("text/xml")
    public String getJobXml(@PathParam("system") String system,
			    @PathParam("id") String jobId,
			    @DefaultValue("90") @QueryParam("confidence") String confidenceStr) {
	return getJobXml(true,system,jobId,confidenceStr);
    }
    */
