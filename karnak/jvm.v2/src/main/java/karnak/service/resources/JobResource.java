...
public class JobResource {
    ...
    */
	...
	if (job.startTime == null) {
		...
		SubmittedStartTimePrediction pred = SubmittedPredictor.getPrediction(query, WeightingEnum.Bagging);
		if (waitPrediction) {
	...
	if (job.startTime == null) {
	    try {
		pred = SubmittedPredictor.getPrediction(query, WeightingEnum.Bagging);
	    } catch (KarnakException e) {
